...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Task 4: Read the file Shapes.txt, create the shapes and store them in
		// your data structure. Then print the number of shapes you created,
		// and finally, print all the shapes and their calculated perimeters and areas polymorphically.
